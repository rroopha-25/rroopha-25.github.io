      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="w-24 md:w-32 h-1.5 md:h-2 bg-gradient-to-r from-blue-400 to-blue-600 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 items-center">
            ...
            <div className="md:col-span-2 flex justify-center order-first md:order-none">
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-blue-600 rounded-3xl blur opacity-30 group-hover:opacity-60 transition duration-500"></div>
                <img
            ...
            <div className="md:col-span-3 space-y-6 md:space-y-8">
              <Card className="p-6 md:p-8 bg-gradient-to-br from-blue-500 to-blue-600 border-2 border-blue-500 hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 rounded-3xl">
              ...
              <div>
                ...
                <div className="space-y-3 md:space-y-4">
                  {about.highlights.map((highlight, index) => (
                    <div
                      key={index}
                      className={`flex items-start gap-3 md:gap-4 p-4 md:p-5 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 hover:border-blue-400/50 hover:bg-white/10 transition-all duration-300 ${
                        isVisible
